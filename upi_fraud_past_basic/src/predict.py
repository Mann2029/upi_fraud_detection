...
try:
    scaler = joblib.load("C:/upi_fraud_past_basic/models/scaler.pkl")
    rf_model = joblib.load("C:/upi_fraud_past_basic/models/random_forest.pkl")
    xgb_model = joblib.load("C:/upi_fraud_past_basic/models/xgboost.pkl")
    lr_model = joblib.load("C:/upi_fraud_past_basic/models/logistic_regression.pkl")
...
data_path = "C:/upi_fraud_past_basic/data/new_transactions.csv"
...
trained_columns = joblib.load("C:/upi_fraud_past_basic/models/trained_columns.pkl")
